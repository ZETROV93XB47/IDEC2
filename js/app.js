...
function authentification(event, connect_with_old_qrcode)
{
	...
	if (!connecting)
	{
		...
		if (app.device.desktop)
		{
			...
			// Jeremy
			var data = '{"url":"https:\/\/osiri.workspace-solution.com\/api\/osiri_mobile_app","token":"ZnJhbWV3b3JrLmNvbnRhY3RzPCohPT8+MTwqIT0\/PjA8KiE9Pz41OGUyNGFmNmU0ZDNiMC4zOTU1Nzk0OTwqIT0\/PiQyeSQxMCRHNVNNR0VUa1A4bzRDZFVTVHJ6VWFlREFaOXpYUnJBNG00TVlVaVZ2dmdXN2ZiU3pDaXRYQw=="}';
